...
<!-- Mirrored from creativelayers.net/themes/superio/blog-list-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Aug 2021 04:57:15 GMT -->
<head>
<meta charset="utf-8">
<title>Superio | Just another HTML Template | Blog List v2</title>
    ...
    <header class="main-header header-shaddow">
        <div class="container-fluid">
            ...
            <div class="main-box">
                ...
                <div class="nav-outer">
                    <div class="logo-box">
                        <div class="logo"><a href="index.html"><img src="<?php echo get_template_directory_uri()."/assets/images/logo.svg" ?>" alt="" title=""></a></div>
                    </div>
                ...
                <div class="content-side col-lg-8 col-md-12 col-sm-12">
                    <div class="blog-grid">
                        ...
                        <div class="news-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/blog-list-1.png" ?>" alt="" /></figure>
                                </div>
                        ...
                        <div class="news-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/blog-list-2.png" ?>" alt="" /></figure>
                                </div>
                                <div class="content-box">
                                    <ul class="post-meta">
                                        <li><a href="#">August 31, 2021</a></li>
                        ...
                        <div class="news-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/blog-list-3.png" ?>" alt="" /></figure>
                                </div>
                                <div class="content-box">
                                    <ul class="post-meta">
                                        <li><a href="#">August 31, 2021</a></li>
                        ...
                        <div class="news-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/blog-list-4.png" ?>" alt="" /></figure>
                                </div>
                                <div class="content-box">
                                    <ul class="post-meta">
                                        <li><a href="#">August 31, 2021</a></li>
                        ...
                        <div class="news-block-two">
                            <div class="inner-box">
                                <div class="image-box">
                                    <figure class="image"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/blog-list-5.png" ?>" alt="" /></figure>
                                </div>
                                <div class="content-box">
                                    <ul class="post-meta">
                                        <li><a href="#">August 31, 2021</a></li>
                ...
                <div class="sidebar-side col-lg-4 col-md-12 col-sm-12">
                    <aside class="sidebar blog-sidebar">
                        ...
                        <div class="sidebar-widget search-widget">
                            <div class="sidebar-title"><h4>Search by Keywords</h4></div>
                        ...
                        <div class="sidebar-widget recent-post">
                            ...
                            <div class="widget-content">
                                <article class="post">
                                    <div class="post-thumb"><a href="blog-single.html"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/post-thumb-1.png" ?>" alt=""></a></div>
                                    <h6><a href="blog-single.html">Attract Sales And Profits</a></h6>
                                    <div class="post-info">August 9, 2021</div>
                                </article>

                                <article class="post">
                                    <div class="post-thumb"><a href="blog-single.html"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/post-thumb-2.png" ?>" alt=""></a></div>
                                    <h6><a href="blog-single.html">5 Tips For Your Job Interviews</a></h6>
                                    <div class="post-info">August 9, 2021</div>
                                </article>

                                <article class="post">
                                    <div class="post-thumb"><a href="blog-single.html"><img src="<?php echo get_template_directory_uri()."/assets/images/resource/post-thumb-3.png" ?>" alt=""></a></div>
                ...
                <div class="row">
                    <div class="big-column col-xl-4 col-lg-3 col-md-12">
                        <div class="footer-column about-widget">
                            <div class="logo"><a href="#"><img src="<?php echo get_template_directory_uri()."/assets/images/logo.svg" ?>" alt=""></a></div>
...
<script src="<?php echo get_template_directory_uri()."/assets/js/chosen.min.js" ?>"></script>
...
<script src="<?php echo get_template_directory_uri()."/assets/js/jquery.modal.min.js" ?>"></script>
<script src="<?php echo get_template_directory_uri()."/assets/js/mmenu.polyfills.js" ?>"></script>
<script src="<?php echo get_template_directory_uri()."/assets/js/mmenu.js" ?>"></script>
...
<!-- Mirrored from creativelayers.net/themes/superio/blog-list-v2.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 21 Aug 2021 04:57:17 GMT -->
</html>
